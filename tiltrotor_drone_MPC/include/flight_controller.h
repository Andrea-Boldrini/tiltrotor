...
private:
    ...
    //double _z_sp_temp;
    bool _sp_adjusted;
    struct {double x,y,x_local,y_local,vx_local,vy_local,z,yaw_deg,yaw_rad,pitch_deg,pitch_rad,roll_deg,roll_rad,vx,vy,vz,p,q,r,tau_x,tau_y,tau_z;} _current;
...
public:
    // Constructor
    FlightController() : mpc(5.1664, 9.8066, 0.026, 0.146, 0.15, 15, 3, 0.1) {};
