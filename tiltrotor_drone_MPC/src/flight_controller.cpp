...
void FlightController::sendCmds()
{
    ...
    std::pair<Eigen::VectorXd, double> dis = wrench_estimator.computeWrench(attitude, velocity, rates, _T_tot, torques, _tilt, _m, _a, _tau_filter, _I.x, _I.y, _I.z);
