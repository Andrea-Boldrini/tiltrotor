...
private:
    ...
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _d_e;
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _previous_e;
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _kp;
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _ki;
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _kd;
    struct {double x,z;} _f;
    struct {double x,y,z,roll,pitch,yaw,vx,vy,vz,tau;} _u;
