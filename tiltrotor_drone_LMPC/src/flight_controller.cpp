...
void FlightController::sendCurrentDronePose()
{
    if (_drone_name_received)
    {
        ...
        std::array<std::array<double, 3>, 3> R_matrix_new1 = Inertial2BodyRotationMatrix(_current.roll_rad, 0, _current.yaw_rad);
        
        std::array<double, 3> _current_rates_body = multiplyMatrixVector(R_matrix_new1, _current_rates_global);
       ...
       std::array<double, 3> _desired_position_global = {_desired.x, _desired.y, _desired.z};
...
void FlightController::sendCmds()
{
    ...
    if (!_yaw_flag) { 
        _desired.x_new1 = _desired.x_new * cos_yaw + _desired.y_new * sin_yaw;
        _desired.y_new1 = -_desired.x_new * sin_yaw + _desired.y_new * cos_yaw;       
       ...
       _desired.x_new1 = _desired.x_new;
       _desired.y_new1 = _desired.y_new;      
    }
    ...
    current_state[4] = _current.z_local;
    current_state[5] = _current.vz_local;
    ...
    ref_state[0] = _desired.x_new1;
    ref_state[1] = 0;
    ref_state[2] = _desired.y_new1;
    ref_state[3] = 0;
    ref_state[4] = _desired.z_new;
    ref_state[5] = 0;
    ref_state[6] = 0;
    ref_state[7] = 0;
    ...
    ROS_INFO("current x: %f", _current.x);
    //ROS_INFO("sp y: %f", _desired.y);
    ROS_INFO("current y: %f", _current.y);
