...
private:
    ...
    std_msgs::Float64MultiArray _current_drone_twist_msg1;
    geometry_msgs::Point _end_effector_msg;
    ...
    geometry_msgs::TwistStamped _velocity_msg;
    ...
    //double _z_sp_temp;
    bool _sp_adjusted;
    struct {double x,y,z,x_local,y_local,vx_local,vy_local,yaw_deg,yaw_rad,pitch_deg,pitch_rad,roll_deg,roll_rad,vx,vy,vz,p,q,r,tau_x,tau_y,tau_z, p_global, q_global, r_global;} _current;
...
public:
    ...
    std::array<std::array<double, 3>, 3> transposeMatrix(const std::array<std::array<double, 3>, 3>& mat);
    std::array<double, 3> addVectors(
