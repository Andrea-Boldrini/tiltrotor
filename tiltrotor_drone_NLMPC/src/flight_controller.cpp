...
void FlightController::sendCmds()
{
    ...
    _rates[0] = _current.p_global;
    _rates[1] = _current.q_global;
    _rates[2] = _current.r_global;
    ...
    std::pair<std::vector<double>, double> sol = mpc.solve(current_state, ref_state, _dis_state_est);
    MPC = sol.first;
